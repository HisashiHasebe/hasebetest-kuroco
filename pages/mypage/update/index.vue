<template>
    <section>
        ...
        <div v-else>
            ...
            <article>
                Notifications:
                <input type="radio" id="subscribe" value="0" v-model.number="user.email_send_ng_flg">
                <label for="subscribe">Subscribe</label>
                <input type="radio" id="unsubscribe" value="1" v-model.number="user.email_send_ng_flg">
                <label for="unsubscribe">Unsubscribe</label>
            </article>

            <button @click="handleOnSubmit">Update</button>
        </div>
    </section>
</template>
